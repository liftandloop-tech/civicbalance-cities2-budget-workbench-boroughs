...
独立的项目设计文档，适用对象： **Cities: Skylines II**。
...
- **区域预算场景** (District budget scenarios) — 规划模块，尚未实现。
- **服务容量表** (Service capacity sheets) — 规划模块，尚未实现。
- **城市快照比较** (City snapshot comparisons) — 规划模块，尚未实现。
...
- [steam-top-sellers](https://store.steampowered.com/search/?filter=topsellers&ignore_preferences=1) — 该产品出现在保存的 Steam 商店筛选结果中。 (2026-09-16T14:19:52.9391145Z)
